...
public class JVentana extends JFrame
{
	...
	public JVentana()
	{
        ...
        lblBy.setHorizontalAlignment(JLabel.RIGHT); //Alineacion a la derecha
        pnlSur.add(lblBy);
        ...
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); //Para que al pulsar en la X finalice la aplicacion
        //Este m�todo siempre debe ser el óltimo mensaje
